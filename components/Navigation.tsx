...
const resources = [
  ...
  { name: 'Community', href: '/discord', icon: <Users className="w-4 h-4" />, external: true },
  { name: 'Tutorials', href: '/tutorials', icon: <Terminal className="w-4 h-4" />, external: true },
]
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            >
              ...
              <span className="text-xs bg-gray-700 px-2 py-0.5 rounded-full">2.1k</span>
            </motion.a>
        ...
        <div className="container py-6 space-y-6">
          ...
          <div className="space-y-3 pt-4 border-t border-gray-800">
            ...
            >
              ...
              <span className="text-xs bg-gray-700 px-3 py-1 rounded-full text-gray-300">2.1k</span>
            </motion.a>
