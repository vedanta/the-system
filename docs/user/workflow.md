...
You can start your journey with The System in two ways:

#### Option A: New Project Creation

```bash
# Start a new project
/ts-new-project my-functional-app
```

#### Option B: Existing Project Analysis (🗺️ Project Explorer)

```bash
# Analyze existing/legacy codebase
/ts-assess --existing legacy-project

# Specific analysis types
/ts-assess --existing my-app --gaps     # Gap analysis
/ts-assess --existing my-app --health   # Code quality
/ts-assess --existing my-app --security # Security scan
/ts-assess --existing my-app --completion # Completion strategy
```

**When to Use Project Explorer:**
- Legacy codebases that need completion or modernization
- Abandoned projects that need assessment
- Third-party code that requires integration
- Technical debt evaluation and remediation planning

**What Project Explorer Provides:**
- Comprehensive technology stack detection
- Gap analysis and missing component identification
- Code quality and security vulnerability assessment
- Completion strategies with effort estimation
- Modernization guidance and technical debt analysis
- Detailed reports saved to `output/` directory for review
...
**What happens**:
- Creates comprehensive project file at `.claude/pipeline/projects/my-functional-app.md`
...
Acceptance Criteria:
- Given I'm logged in, when I click "New Task", then I see a form with title and description fields
- Given I fill out the form, when I click "Save", then the task appears in the task list
```
...
/ts-validate           # Proceed only when validation passes
```
