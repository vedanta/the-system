#!/bin/bash
# Lean Documentation Mode Validation Script
...
# Execute turbo mode with explicit lean flag using expect
expect << 'EXPECT_EOF'
spawn claude
send "/ts-turbo lean-mode-test \"Simple calculator app\" --docs=lean\r"
expect eof
EXPECT_EOF
